...
@section('main-content')
    ...
    <div class="user-cakesTypes-edit-Page container">
        ...
        <h1 class="text-center mt-2 mb-3">Modifica la ricetta di <strong>{{ $cakeType->name }}</strong></h1>
            <form
                action="{{ route('user.cake_types.update', $cakeType->slug) }}"
            ...
            >
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        min="1"
                        max="100"
                        value="{{ old('price', $cakeType->getPriceAsNumber() ) }}"
                    >
                </div>
                <div class="form-group">
                ...
                <div class="form-group text-right pr-5 mt-5">
                    <button type="submit" class="btn btn-primary">Modifica ricetta</button>
                </div>
            </form>
        </section>
    </div>
